...
class PanelFunc:
    ...
    Attributes:
    - in_attrs: dict, determines which DataContainers to operate on.
    - rm_attrs: dict, determines which DataContainers to exclude from operation.
    """
    ...
    def __init__(self, 
        ...
        """
        self.in_attrs: Dict[str, str] = in_attrs if in_attrs is not None else {}
        self.rm_attrs: Dict[str, str] = rm_attrs if rm_attrs is not None else {}
    ...
    def getMatching(self, 
                    panel: Panel, 
                    in_attrs: Optional[Dict[str, str]] = None, 
                    rm_attrs: Optional[Dict[str, str]] = None) -> List[DataContainer]:
        """
        Filter DataContainers in a Panel based on inclusion and exclusion attributes.

        :param panel: The Panel object containing DataContainers.
        :param in_attrs: Dictionary of attributes to include (default: use self.in_attrs).
        :param rm_attrs: Dictionary of attributes to exclude (default: use self.rm_attrs).
        :return: A list of matching DataContainers.
        """
        in_attrs = in_attrs if in_attrs is not None else self.in_attrs
        rm_attrs = rm_attrs if rm_attrs is not None else self.rm_attrs
        return [dc for dc in panel if dc.isMatch(in_attrs, rm_attrs)]
